...
en tenant compte des couts des cases
"""
...
def meilleur_chemin(grille):
    ...
    Le choix est penalise par le cout des cases
    afin de rester coherent avec le comportement des fourmis
    """
    ...
    while position != POSITION_NOURRITURE and len(chemin) < limite:
        ...
        for v in voisins:
            ...
            valeur_pheromone = grille[v[0]][v[1]]
            cout = cout_case(v)

            valeur = valeur_pheromone / float(cout)
