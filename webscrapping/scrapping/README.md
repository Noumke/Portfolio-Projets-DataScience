...
> ⚠️ **Durée estimée : 5 a 8 minutes** des délais aléatoires sont inclus pour éviter d'être bloqué par Cloudflare.
...
## ⚙️ Configuration  de `settings.py`
...
**Noumke TOURE** ÉtEdiant Data Science, Université Clermont Auvergne  
